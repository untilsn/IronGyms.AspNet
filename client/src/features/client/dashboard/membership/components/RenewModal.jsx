...
export default function RenewModal({ open, onClose, plan, onConfirm, isSubmitting }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="surface-card rounded-box w-full max-w-sm p-6">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="font-display text-lg font-bold">Gia hạn gói tập</h3>
        ...
        {plan && (
          <div className="bg-base-300/50 mb-4 rounded-lg p-3 text-sm">
            ...
            <p className="text-base-content/50">{formatCurrency(plan.price)}</p>
          </div>
        )}
