...
export default function AdminSidebar() {
  ...
  return (
    <aside
      className={`border-base-300 bg-base-200 fixed inset-y-0 left-0 z-30 flex flex-col border-r transition-[width] duration-200 ${
        collapsed ? "w-16" : "w-64"
      }`}
    >
      <div className="flex h-16 items-center justify-between px-4">
        ...
        <button onClick={toggleSidebar} className="btn btn-ghost btn-square btn-sm">
          <ChevronLeft
            size={18}
