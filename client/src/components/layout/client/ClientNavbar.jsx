          ...
          <div className="dropdown dropdown-end">
            ...
            >
              <span className="relative flex">
                {/* Avatar */}
                <span className="bg-primary/20 text-primary flex h-8 w-8 items-center justify-center overflow-hidden rounded-full text-sm font-semibold">
                  {user?.avatarUrl ? (
                    <img
                      src={user.avatarUrl}
